...
void mainCase() {
  ...
  auto most_freq = max_element(ALL(freqs), [](auto x, auto y) { return x.second < y.second; });
  // DD(*most_freq);

  // rock -> scissor -> paper
  map<char, char> convert = {{'R', 'P'}, {'S', 'R'}, {'P', 'S'}};
  char c = convert[most_freq->first];
  FOR(i, 0, n) {
    cout << c;
  }
  cout << endl;
...
/*
python misc/run.py codeforces/edu91/b/main.cpp --check
