...
void mainCase() {
  ...
  // Utility for below
  auto boundedMaxSegmentCyclic = [&](int w0, int w1, const vector<int>& co) -> ll {
    if (w1 == 0) { return 0; }
  ...
  // Score for each component (TODO: probably wrong reasoning here??)
  int l = compos.size();
...
/*
python misc/run.py atcoder/abc175/d/main_v2.cpp --check
