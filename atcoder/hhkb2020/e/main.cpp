...
// NOTE: lamp influences not only direct neighbor but also whole segment.
...
void mainCase() {
  ...
  int cnt = 0;
  const int k_lim = 6;
  array<int, k_lim> cnts = {}; // distribution wrt tidy neighbor count (1..5)
  FOR(i, 0, n) {
    FOR(j, 0, m) {
...
/*
python misc/run.py atcoder/hhkb2020/e/main.cpp
