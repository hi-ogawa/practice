...
struct SegmentTree {
  ...
  SegmentTree(int n) {
    ...
    data_.resize(1 << (depth_ + 1)); // Sum, Xor
...
/*
python misc/run.py cses/range_queries/task1650/main.cpp --check
