...
def main_case() -> None:
    ...
    ls = array("l", [x - 1 for x in map(int, read_tokens())])  # {0, .., n - 1}
...
"""
python misc/run.py cses/sorting_and_searching/task2217/main_v2.py

python misc/run.py cses/sorting_and_searching/task2217/main_v2.py --test "file:cses/sorting_and_searching/task2217/2.txt" --truncate 100
