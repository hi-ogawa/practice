...
// Cf. https://en.wikipedia.org/wiki/Hopcroft%E2%80%93Karp_algorithm

// NOTE: AC but probably incorrect (i.e. the same proof of complexity bound is not valid this algorithm)
...
/*
python misc/run.py library_checker/bipartitematching/main.cpp
